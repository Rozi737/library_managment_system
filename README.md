This is a Library Management System built using PHP, HTML, CSS, and Bootstrap. It allows users to manage books, members, and borrowing records efficiently, with a simple and user-friendly interface.
